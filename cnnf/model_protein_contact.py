...
class CNNF(nn.Module):
    ...
    def __init__(self, num_metrics, ind=0, cycles=2, res_param=0.1):
        ...
        self.conv1 = layers.Conv2d(55, 16, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.maxpool2 = layers.MaxPool2d(6)
        ...
        self.maxpool3 = layers.MaxPool2d(10)
        ...
        self.fc1 = layers.Linear(3200, 9)
        self.fc1_bias = layers.Bias((1,9))
        self.relu4 = layers.resReLU(res_param)
        self.fc2 = layers.Linear(9, num_metrics)
        self.fc2_bias = layers.Bias((1,num_metrics))
...
class CNNF_larger(nn.Module):
    ...
    def __init__(self, num_metrics, ind=0, cycles=2, res_param=0.1):
        ...
        self.ins3_bias = layers.Bias((1, 32, 1, 1))
        self.relu3 = layers.resReLU(res_param)
        self.maxpool3 = layers.MaxPool2d(6)
        self.conv4 = layers.Conv2d(32, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.ins4 = layers.InsNorm()
        self.ins4_bias = layers.Bias((1,64,1,1))
        self.relu4 = layers.resReLU(res_param)
        self.maxpool4 = layers.MaxPool2d(10)
        self.flatten = layers.Flatten()
        self.fc1 = layers.Linear(6400, 100)
        self.fc1_bias = layers.Bias((1, 100))
        self.relu5 = layers.resReLU(res_param)
        self.fc2 = layers.Linear(100, 10)
        self.fc2_bias = layers.Bias((1, 10))
        self.relu6 = layers.resReLU(res_param)
        self.fc3 = layers.Linear(10, num_metrics)
        self.fc3_bias = layers.Bias((1,num_metrics))
